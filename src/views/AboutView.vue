    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Swift',
          imageUrl: 'https://cdn.worldvectorlogo.com/logos/swift-15.svg',
          status: 'advance'
        },
        {
          id: 7,
        ...
        },
        {
          id: 8,
          name: 'Golang',
          imageUrl: 'https://cdn.worldvectorlogo.com/logos/golang-1.svg',
          status: 'Beginner'
        },
        {
          id: 9,
      ...
      tools: [
        ...
        },
        {
          id: 6,
          name: 'XCODE',
          imageUrl: 'https://developer.apple.com/assets/elements/icons/xcode-12/xcode-12-96x96_2x.png',
          status: 'Code Editor'
        },
        {
          id: 7,
          name: 'Android Studio',
          imageUrl: 'img/androidIcon.svg',
          status: 'Code Editor'
        },
      ]
    };
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="/img/profil1.jpeg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Exaudi Siregar. I am a student at the Del Institute of Technology, majoring in Software Engineering Technology, from North Sumatra. I have one year of experience in Front-End web development projects for creating school websites that are done according to client needs.

I really enjoy what I do. For me, programming is not just a technical job, but also an art form that has its own aesthetic value.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My main focus is building websites that are functional, user-friendly, and still visually appealing. I always try to give a personal touch to each product, ensuring that the website built is not only eye-catching, but also easy to use. My goal is to convey your message and identity in the most creative and effective way.

If you are interested in working together or want to hire me, please contact me through the contact provided. I am ready to help turn your ideas into real digital solutions.
          </p>
        </div>
