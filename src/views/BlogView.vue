<template>
  <div class="container mx-auto p-3 md:p-8">
    ...
    <!-- Jika ArticleList memang perlu digunakan -->
...
// import ArticleList from '@/components/ArticleList.vue'; // Uncomment jika ArticleList digunakan
...
.paraf {
  -webkit-line-clamp: 3;
  line-clamp: 3; /* Standard property untuk browser lain */
