      ...
      items: [
        {
          ...
          github: 'https://github.com/Exaudi2003/PortovolioOnline',
          demo: '#'
        },
        {
          id: 2,
          name: 'Nightmare Seekers',
          status: 'Game 2D simple ios',
          tech: 'Swift, SwiftUI',
          github: '#',
          demo: '#'
        },
        ...
        {
          id: 4,
          name: 'SMK - Paskita Global',
          imagePath: 'paskita.png',
          imageWidth: '100px',
    imageHeight: '100px',
          status: 'A web application designed for schools to manage and provide easy access to school information, such as teacher information, announcements.',
        ...
        },
        {
          ...
          status: 'Game 2D simple ios',
          tech: 'SWIFT, SwiftUI',
          github: 'https://github.com/Exaudi2003/CrashCar-IOSGames.git',
          demo: 'null'
        }
      ]
    };
                    ...
                    <div class="flex cursor-pointer items-end gap-2 text-primary">
                      <a v-if="item.github !== 'null'" :href="item.github" target="_blank" rel="noreferrer" title="View github repository" class="transition-all hover:text-accent">
                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                          ...
                          5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 
                          5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                        </svg>
                      </a>
